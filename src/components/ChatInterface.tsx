          ...
          <>
            ...
            <CardContent className="flex-1 flex flex-col p-0">
              ...
              <div className="p-4">
                ...
                {/* Mostrar assistente selecionado para auto-conversas */}
                {selectedChat.chatId.includes(greenAPIState.phoneNumber.replace(/\D/g, '')) && (
                  <div className="mt-2 text-xs text-gray-500 flex items-center gap-1">
                    <Brain className="h-3 w-3" />
                    Assistente ativo: {selectedAssistant}
                  </div>
                )}
              </div>
            </CardContent>
