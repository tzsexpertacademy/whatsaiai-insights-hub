...
export function PersonalAssistantConfig() {
  ...
  const { sendMessage, wppConfig, connectionState } = useRealWhatsAppConnection();
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
                ...
                <li>Configure seu número master primeiro</li>
                <li>Ative o assistente</li>
                <li>Use este teste para verificar se o envio de mensagens está funcionando</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
            ...
            <ol className="text-sm text-amber-700 space-y-1 list-decimal list-inside">
              ...
              <li>Ative o assistente</li>
              <li>Use o botão de teste para verificar se está funcionando</li>
              <li>Configure webhooks no WPPConnect para receber mensagens automaticamente</li>
